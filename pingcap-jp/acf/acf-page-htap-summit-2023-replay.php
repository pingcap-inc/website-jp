<?php
$acf_group = 'tmpl_htap_summit_replay';

acf_add_local_field_group(array(
    'key' => 'group_' . $acf_group,
    'title' => 'HTAP Summit Replay Content',
    'fields' => array(
        array(
            'key' => 'field_' . $acf_group . '_content',
            'label' => 'Sections',
            'name' => 'htap_summit_replay_content',
            'type' => 'repeater',
            'instructions' => '',
            'required' => 0,
            'conditional_logic' => 0,
    ...
    'location' => array(
        array(
            array(
                ...
                'operator' => '==',
                'value' => 'templates/page-htap-summit-2023-replay.php',      // if options_page then use: acf-options  | if page_template then use:  template-example.php
                'order_no' => 0,
                'group_no' => 1,
            ),
        ),
