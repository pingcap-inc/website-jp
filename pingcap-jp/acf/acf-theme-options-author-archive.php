...
$acf_group = Constants\ACF::THEME_OPTIONS_AUTHOR_ARCHIVES_BASE;

acf_add_local_field_group(array (
	'key' => 'group_' . $acf_group,
	'title' => 'Author Archive Settings',
	'fields' => array (
		array (
			...
			'type' => 'true_false',
			'instructions' => 'Enabling this option will allow you to override the default value under <a href="' . get_admin_url() . 'options-reading.php">Settings / Reading</a> for author archives.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array (
				'width' => '50',
		...
		array (
			...
			'default_value' => PingCAP\Constants\DefaultValues::AUTHOR_ARCHIVE_NO_RESULTS_MESSAGE,
			'placeholder' => '',
		...
		array (
			'key' => 'field_' . $acf_group . '_author_archive_blocks',
			'label' => 'Author Archive',
			'name' => $acf_group . '_author_archive_blocks',
			'type' => 'clone',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
	...
	'location' => array (
		array (
			array (
				...
				'operator' => '==',
				'value' => 'acf-theme-options-author-archives',        // if options_page then use: acf-options  | if page_template then use:  template-example.php
				'order_no' => 0,
				'group_no' => 1,
			),
		),
