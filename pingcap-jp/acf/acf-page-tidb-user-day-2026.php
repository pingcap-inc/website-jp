<?php
$acf_group = 'tmpl_page_tidb_user_day_2026';

acf_add_local_field_group(array(
	'key' => 'group_' . $acf_group,
	'title' => 'TiDB User Day 2026 Content Settings',
	'fields' => array(
		/**
		 * Tab: Banner
		 */
	...
	'location' => array(
		array(
			array(
				...
				'operator' => '==',
				'value' => 'templates/page-tidb-user-day-2026.php',      // if options_page then use: acf-options  | if page_template then use:  template-example.php
				'order_no' => 0,
				'group_no' => 1,
			),
		)
