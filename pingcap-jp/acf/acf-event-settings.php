...
$acf_group = Constants\ACF::EVENT_SETTINGS_BASE;
...
acf_add_local_field_group(array (
	...
	'fields' => array (
		 ...
		 */
		array (
			'key' => 'field_' . $acf_group . '_tab_event_archive',
			'label' => 'Event Archive',
			'name' => 'tab_event_archive',
			'type' => 'tab',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			...
			'post_type' => PingCAP\Constants\CPT::EVENT,
			'taxonomy' => array (),
			'allow_null' => 1,
			'multiple' => 0,
		...
		array (
			'key' => 'field_' . $acf_group . '_event_archive_blocks',
			'label' => 'Event Archive',
			'name' => $acf_group . '_event_archive_blocks',
			'type' => 'clone',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		/**
		 * Tab: Event Post Blocks
		 */
		array (
			'key' => 'field_' . $acf_group . '_tab_event_post_blocks',
			'label' => 'Event Post Blocks',
			'name' => 'tab_event_post_blocks',
			'type' => 'tab',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			'key' => 'field_' . $acf_group . '_event_post_blocks',
			'label' => 'Event Post',
			'name' => $acf_group . '_event_post_blocks',
			'type' => 'clone',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
	...
	'location' => array (
		array (
			array (
				...
				'operator' => '==',
				'value' => 'event-settings',        // if options_page then use: acf-options  | if page_template then use:  template-example.php
				'order_no' => 0,
				'group_no' => 1,
			),
		),
