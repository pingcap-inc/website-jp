...
$acf_group = Constants\ACF::EBOOK_WHITEPAPER_SETTINGS_BASE;

acf_add_local_field_group(array (
	'key' => 'group_' . $acf_group,
	'title' => 'eBook / White Paper Settings',
	'fields' => array (
		/**
		 * Tab: eBook / White Paper Archive
		 */
		array (
			'key' => 'field_' . $acf_group . '_tab_ebook_whitepaper_archive',
			'label' => 'eBook / White Paper Archive',
			'name' => 'tab_ebook_whitepaper_archive',
			'type' => 'tab',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			...
			'default_value' => 'eBooks & White Papers',
			'placeholder' => '',
		...
		array (
			...
			'post_type' => PingCAP\Constants\CPT::EBOOK_WHITEPAPER,
			'taxonomy' => array (),
			'allow_null' => 1,
			'multiple' => 0,
		...
		array (
			'key' => 'field_' . $acf_group . '_ebook_whitepaper_archive_blocks',
			'label' => 'eBooks / White Papers Archive',
			'name' => $acf_group . '_ebook_whitepaper_archive_blocks',
			'type' => 'clone',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		/**
		 * Tab: eBook / White Paper Post Blocks
		 */
		array (
			'key' => 'field_' . $acf_group . '_tab_ebook_whitepaper_post_blocks',
			'label' => 'eBook / White Paper Post Blocks',
			'name' => 'tab_ebook_whitepaper_post_blocks',
			'type' => 'tab',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			'key' => 'field_' . $acf_group . '_ebook_whitepaper_post_blocks',
			'label' => 'eBook / White Paper Post',
			'name' => $acf_group . '_ebook_whitepaper_post_blocks',
			'type' => 'clone',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
	...
	'location' => array (
		array (
			array (
				...
				'operator' => '==',
				'value' => 'ebook-whitepaper-settings',        // if options_page then use: acf-options  | if page_template then use:  template-example.php
				'order_no' => 0,
				'group_no' => 1,
			),
		),
