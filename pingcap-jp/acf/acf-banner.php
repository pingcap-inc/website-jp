...
$banner_fields = array_merge(
	array(
		...
		array(
			'key' => 'field_' . $acf_group . '_banner_bg_mb',
			'label' => 'Banner mobile bg',
			'name' => $acf_group . '_banner_bg_mb',
			'instructions' => '',
			'type' => 'image',
			'required' => 0,
			'conditional_logic' => array(
		...
		array(
			'key' => 'field_' . $acf_group . '_banner_min_height_desktop',
			'label' => 'Banner Minimum Height on PC',
			'name' => $acf_group . '_banner_min_height_desktop',
			'type' => 'number',
		...
		array(
			'key' => 'field_' . $acf_group . '_banner_min_height_mobile',
			'label' => 'Banner Minimum Height on Mobile',
			'name' => $acf_group . '_banner_min_height_mobile',
			'type' => 'number',
			'instructions' => 'This setting only applies to mobile screen sizes.',
			'required' => 0,
			'conditional_logic' => 0,
			'wrapper' => array(
				'width' => '50',
