...
$acf_group = Constants\ACF::PRESS_RELEASE_SETTINGS_BASE;
...
acf_add_local_field_group(array (
	...
	'fields' => array (
		/**
		 * Tab: Press Release Archive
		 */
		array (
			'key' => 'field_' . $acf_group . '_tab_press_release_archive',
			'label' => 'Press Release Archive',
			'name' => 'tab_press_release_archive',
			'type' => 'tab',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			...
			'post_type' => PingCAP\Constants\CPT::PRESS_RELEASE,
			'taxonomy' => array (),
			'allow_null' => 1,
			'multiple' => 0,
		...
		array (
			'key' => 'field_' . $acf_group . '_press_release_archive_blocks',
			'label' => 'Press Release Archive',
			'name' => $acf_group . '_press_release_archive_blocks',
			'type' => 'clone',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		/**
		 * Tab: Press Release Post Blocks
		 */
		array (
			'key' => 'field_' . $acf_group . '_tab_press_release_post_blocks',
			'label' => 'Press Release Post Blocks',
			'name' => 'tab_press_release_post_blocks',
			'type' => 'tab',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			'key' => 'field_' . $acf_group . '_press_release_post_blocks',
			'label' => 'Press Release Post',
			'name' => $acf_group . '_press_release_post_blocks',
			'type' => 'clone',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
	...
	'location' => array (
		array (
			array (
				...
				'operator' => '==',
				'value' => 'press-release-settings',        // if options_page then use: acf-options  | if page_template then use:  template-example.php
				'order_no' => 0,
				'group_no' => 1,
			),
		),
