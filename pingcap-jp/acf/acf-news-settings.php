...
$acf_group = Constants\ACF::NEWS_SETTINGS_BASE;
...
acf_add_local_field_group(array (
	...
	'fields' => array (
		 ...
		 */
		array (
			'key' => 'field_' . $acf_group . '_tab_news_archive',
			'label' => 'News Archive',
			'name' => 'tab_news_archive',
			'type' => 'tab',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			'key' => 'field_' . $acf_group . '_news_archive_blocks',
			'label' => 'News Archive',
			'name' => $acf_group . '_news_archive_blocks',
			'type' => 'clone',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
	...
	'location' => array (
		array (
			array (
				...
				'operator' => '==',
				'value' => 'news-settings',        // if options_page then use: acf-options  | if page_template then use:  template-example.php
				'order_no' => 0,
				'group_no' => 1,
			),
		),
