...
$acf_group = Constants\ACF::TRAINING_SETTINGS_BASE;
...
acf_add_local_field_group(array (
	...
	'fields' => array (
		/**
		 * Tab: Training Archive
		 */
		array (
			'key' => 'field_' . $acf_group . '_tab_training_archive',
			'label' => 'Training Archive',
			'name' => 'tab_training_archive',
			'type' => 'tab',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			...
			'post_type' => PingCAP\Constants\CPT::TRAINING,
			'taxonomy' => array (),
			'allow_null' => 1,
			'multiple' => 0,
		...
		array (
			'key' => 'field_' . $acf_group . '_training_archive_blocks',
			'label' => 'Training Archive',
			'name' => $acf_group . '_training_archive_blocks',
			'type' => 'clone',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		/**
		 * Tab: Training Post Blocks
		 */
		array (
			'key' => 'field_' . $acf_group . '_tab_training_post_blocks',
			'label' => 'Training Post Blocks',
			'name' => 'tab_training_post_blocks',
			'type' => 'tab',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			'key' => 'field_' . $acf_group . '_training_post_blocks',
			'label' => 'Training Post',
			'name' => $acf_group . '_training_post_blocks',
			'type' => 'clone',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
	...
	'location' => array (
		array (
			array (
				...
				'operator' => '==',
				'value' => 'training-settings',        // if options_page then use: acf-options  | if page_template then use:  template-example.php
				'order_no' => 0,
				'group_no' => 1,
			),
		),
