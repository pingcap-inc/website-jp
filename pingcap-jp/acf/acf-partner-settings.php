...
$acf_group = Constants\ACF::PARTNER_SETTINGS_BASE;
...
acf_add_local_field_group(array (
	...
	'fields' => array (
		 ...
		 */
		array (
			'key' => 'field_' . $acf_group . '_tab_partner_archive',
			'label' => 'Partner Archive',
			'name' => 'tab_partner_archive',
			'type' => 'tab',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			...
			'post_type' => PingCAP\Constants\CPT::PARTNER,
			'taxonomy' => array (),
			'allow_null' => 1,
			'multiple' => 0,
		...
		array (
			'key' => 'field_' . $acf_group . '_partner_archive_blocks',
			'label' => 'Partner Archive',
			'name' => $acf_group . '_partner_archive_blocks',
			'type' => 'clone',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		/**
		 * Tab: Partner Post Blocks
		 */
		array (
			'key' => 'field_' . $acf_group . '_tab_partner_post_blocks',
			'label' => 'Partner Post Blocks',
			'name' => 'tab_partner_post_blocks',
			'type' => 'tab',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
		...
		array (
			'key' => 'field_' . $acf_group . '_partner_post_blocks',
			'label' => 'Partner Post',
			'name' => $acf_group . '_partner_post_blocks',
			'type' => 'clone',
			'instructions' => '',
			'required' => 0,
			'conditional_logic' => 0,
	...
	'location' => array (
		array (
			array (
				...
				'operator' => '==',
				'value' => 'partner-settings',        // if options_page then use: acf-options  | if page_template then use:  template-example.php
				'order_no' => 0,
				'group_no' => 1,
			),
		),
