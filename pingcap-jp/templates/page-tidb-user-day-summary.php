...
<main class="tmpl-summary__content bg-black-dark">
    ...
    <div class="contain">
        ...
        <div>ご参加ありがとうございました！</div>
        <div>次回のイベントは2026年10月28日〜30日に開催します。</div>
        <div class="button-group">
            <a class="button js--trigger-form-modal" data-form-id="cc527b2b-dcf3-4d9a-97f6-fd72fc97e9e8">動画を視聴する</a>
