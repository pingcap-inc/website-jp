	...
	<div class="block-inner">
		...
		<div class="block-pricing__table-container">
			...
			>
				<thead>
					<tr>
						<th><?php _e('Tier', Constants\TextDomains::DEFAULT); ?></th>
						<th><?php _e('Node', Constants\TextDomains::DEFAULT); ?></th>
						<th><?php _e('CPU', Constants\TextDomains::DEFAULT); ?></th>
						<th><?php _e('Storage', Constants\TextDomains::DEFAULT); ?></th>
						<th><?php _e('Node Cost Per Hour', Constants\TextDomains::DEFAULT); ?></th>
						<th><?php _e('Storage Base Price per Hour', Constants\TextDomains::DEFAULT); ?></th>
						<th><?php _e('Storage Cost per GB/hour', Constants\TextDomains::DEFAULT); ?></th>
					</tr>
				</thead>
				<tbody>
					<?php
					...
					
					{
						foreach ($tier->rows as $row_index => $row)
						{
							...
							<tr class="<?php echo esc_attr(implode(' ', $tr_classes)); ?>">
								...
								<td><?php echo esc_attr($row->sbph); ?></td>
