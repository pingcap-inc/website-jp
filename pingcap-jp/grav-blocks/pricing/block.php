...
?>
	<div class="block-inner">
		...
		<div class="block-pricing__controls-container contain">
			<div class="block-pricing__control-group bg-white">
				...
				<div class="block-pricing__providers-container">
					...
					?>
						<button class="<?php echo esc_attr(implode(' ', $btn_classes)); ?>" aria-label="<?php echo esc_attr($title); ?>" data-provider-id="<?php echo esc_attr($provider_id); ?>">
		...
		<div class="block-pricing__table-container">
			...
			<table class="block-pricing__table table--black-header table--header-align-bottom" data-selected-provider-id="0" data-selected-region-id="0" data-providers-data="<?php echo htmlspecialchars(json_encode($providers_data_array)); ?>">
				...
				<tbody>
					...
					?>
							<tr class="<?php echo esc_attr(implode(' ', $tr_classes)); ?>">
								...
								<td><?php echo esc_attr($row->mcpn); ?></td>
								<td><?php echo esc_attr($row->pphcpn); ?></td>
								<td><?php echo esc_attr($row->ppmcpn); ?></td>
