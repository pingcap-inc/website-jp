...
$block_fields = array(
	array(
		'key' => 'field_' . $block . '_header_label',
		'label' => 'Table Header Labels',
		'name' => 'header_label',
		'type' => 'repeater',
		'instructions' => 'These are the column labels for the pricing table. The labels are ordered from left to right',
		'required' => 1,
		'conditional_logic' => 0,
		'wrapper' => array(
			'width' => '',
		...
		'sub_fields' => array(
			array(
				'key' => 'field_' . $block . '_header_field',
				'label' => 'Header Field',
				'name' => 'header_field',
				'type' => 'text',
				'instructions' => '',
