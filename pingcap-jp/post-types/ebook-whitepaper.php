<?php
$single_label = 'eBook / White Paper';
$plural_label = 'eBooks / White Papers';
...
register_post_type(
	...
	[
		...
		'rewrite' => [
			'with_front' => false,
			'slug' => PingCAP\Constants\CPT::EBOOK_WHITEPAPER
		],
		'query_var' => true,
		...
		'taxonomies' => [
			PingCAP\Constants\Taxonomies::BLOG_CATEGORY,
			PingCAP\Constants\Taxonomies::BLOG_TAG
		],
		'labels' => [
			'name' => $plural_label,
